            ...
            <div style={{background: 'var(--surface)', padding: '2rem', borderRadius: 'var(--radius)', border: '1px solid var(--border)', boxShadow: '0 4px 6px rgba(0,0,0,0.05)'}}>
                ...
                <div style={{display: 'flex', gap: '1rem', marginTop: '3rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border)'}}>
                    ...
                    {returnableItems.length > 0 && (
                        <button onClick={() => router.push(`/sales/${sale.id}/return`)} style={{flex: 1, padding: '1rem', background: '#fff1f2', color: '#be123c', border: '1px solid #fecdd3', borderRadius: 'var(--radius)', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem', fontWeight: 600}}>
